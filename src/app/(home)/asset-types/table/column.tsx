...
import { IAssetType } from "@/providers/http/asset-types/interface";
...
export const columns = ({
  ...
  {
    accessorKey: "purchaseAccount.name",
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={"Purchase Account"} />
    ),
  },
  {
    accessorKey: "depreciationAccount.name",
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={"Depreciation Account"} />
    ),
  },
  {
    accessorKey: "status",
